...
if ( !class_exists( 'factorycommercegurus_Redux_Framework_config' ) ) {
	...
	class Factorycommercegurus_Redux_Framework_config {
		...
		public function setSections() {
			 ...
			 * */
			$this->sections[] = array(
				'title'	 => esc_html__( 'Global Settings - w=p=l=o=c=k=e=r=.=c=o=m', 'factory' ),
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'default'	 => '#cccccc',
						'output'	 => array( 'color' => '.cg-primary-menu-left.cg-primary-menu .menu > li > a:hover, .cg-primary-menu-left.cg-primary-menu .menu > li:hover > a' )
					),
					array(
