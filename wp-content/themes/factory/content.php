...
?>
			...
			<?php if ( $factorycommercegurus_news_layout == 'grid-news' ) { ?>
					...
					<header class="entry-header">
					<div class="blog-meta">
							<span class="cg-blog-date"><time class="entry-date published updated" datetime="%1$s"><?php factorycommercegurus_posted_on(); ?></time></span> <?php factorycommercegurus_get_author_name(); ?> <span class="comments"><a href="<?php comments_link(); ?>"><?php comments_number(); ?></a></span>
