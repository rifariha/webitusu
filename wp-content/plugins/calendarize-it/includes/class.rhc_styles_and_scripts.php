...
class rhc_styles_and_scripts {
	...
	function admin_and_frontend_scripts(){
		...
		if( $this->debugging_js_css ){
			...
			wp_register_script( 'calendarize', RHC_URL.'js/calendarize.js', $dependency,'4.5.0.2',$this->in_footer);
		}else{
			...
			wp_register_script( 'calendarize', RHC_URL.'js/frontend.min.js', $dependency,'4.5.0.2',$this->in_footer);
		}
